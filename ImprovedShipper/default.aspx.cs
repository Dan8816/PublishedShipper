...
namespace ImprovedShipper
{
    public partial class ShippingRequest : System.Web.UI.Page
    {
        ...
        //protected void ddlSubDepartments_SelectedIndexChanged(object sender, EventArgs e)//commented out by Dan Engle 11/28/2018 due to updated list subdepts are no longer needed
        //{
        //    txtFromName.Focus();
        //}
        ...
        protected void ddlInitiatingDepartment_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //if (ddlInitiatingDepartment.SelectedItem.Text == "Administration")//commented out by Dan Engle 11/28/2018 due to db changes subs are no longer needed
            //{
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (ValidPage == true)
            {
                ...
                //if (ddlInitiatingDepartment.SelectedItem.Text == "Administration" || ddlInitiatingDepartment.SelectedItem.Text == "MX" || ddlInitiatingDepartment.SelectedItem.Text == "Operations")//commented out by Dan Engle 11/28/2018 no longer need subdepts
        ...
        private void ValidatePage()
        {
            ...
            if (txtToAttn.Text == string.Empty && ddlCountries.SelectedValue != "US")//This is a required field for intl shipments added by Dan Engle 11/16/2018
            {
                ...
                //OAI_ValidationSummary.Append("* ATTN is a required field for International shipment.");
